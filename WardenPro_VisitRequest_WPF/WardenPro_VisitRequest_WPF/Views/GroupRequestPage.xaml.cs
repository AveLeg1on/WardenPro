...
{
    /// <summary>
    /// Логика взаимодействия для GroupRequestPage.xaml
    /// </summary>
    public partial class GroupRequestPage : Page
    {
        ...
        private void ClearForm()
        {
            ...
            visitorPanel.DataContext = new VisitorModel();
        }
        ...
        private void Save_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(model.GroupName))
                errors.AppendLine("Укажите имя группы");

            if (model.Visitors.Count == 0)
                errors.AppendLine("Укажите посетителей");
        ...
        private void AddVisitorInList_Click(object sender, RoutedEventArgs e)
        {
            StringBuilder errors = new StringBuilder();

            var visitor = visitorPanel.DataContext as VisitorModel;
            ...
            VisitRequest.Visitors.Add(visitor);
